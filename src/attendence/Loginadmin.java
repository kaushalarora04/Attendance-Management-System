...
public class Loginadmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(202, 192, 202));
        ...
        jLabel7.setText("Attendence Management System");

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/download.jpg"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(619, 393));
...
String p=new String(pass);
        if(s.equals(""))
        {
            ...
            jLabel2.setText("Admin id is required");
        }
        if(p.equals(""))
        {
            ...
            {
                if(s.equals("rahul") && p.equals("123"))
                {
                ...
                else
                {
                  ...
                  jLabel9.setText("Invalid Id/Password");  
                }
            }
