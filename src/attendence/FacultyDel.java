...
public class FacultyDel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Delete Faculty Record");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        PreparedStatement ps=con.prepareStatement("delete from faculty where faculty_id=?");
                ps.setString(1, id);
                ps.executeUpdate();
                JOptionPane.showMessageDialog(this,"Faculty record removed successfully");
                jTextField1.setText("");
                con.close();
        }    
        catch(Exception e)
