...
public class PassChange extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/password_logo.jpg"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        PreparedStatement ps=con.prepareStatement("select pass from student where student_id=?");
        ps.setString(1,Attendence.t_id);
        ...
        else
        {
            ...
            {
                PreparedStatement ps2=con.prepareStatement("update student set pass=? where student_id=?");
                ps2.setString(1,newp);
                ps2.setString(2,Attendence.t_id);
                ps2.executeUpdate();
